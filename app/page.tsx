...
// AGENTISS - Modern 3D Landing Page
// Atendimento automático (atendentes de IA) + Landing Pages com elementos 3D modernos
// CTAs para WhatsApp com mensagens personalizadas por seção
// Toggle Mensal/Anual (-15%), pricing com efeitos 3D, Hero com chat e elementos 3D
...
export default function AGENTISSLanding() {
  ...
  return (
    <div className="min-h-screen bg-[#0b0d10] text-white antialiased overflow-x-hidden">
      <SEO />
      <InlineStyles />
      ...
      <main className="max-w-6xl mx-auto px-6">
        {/* HERO - Conversa WhatsApp com elementos 3D */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center relative z-10">
            <div className="reveal">
              <h1 className="text-4xl sm:text-5xl font-extrabold leading-tight tracking-tight">
                Atendentes de IA que vendem e marcam consultas
            ...
            {/* Chat mock com elementos 3D */}
            <div className="reveal">
              <div className="chat-container-3d group relative w-full rounded-2xl border border-white/10 bg-white/5 backdrop-blur-md shadow-2xl overflow-hidden min-h-[460px] h-[520px] md:h-[580px]">
                <div className="absolute inset-0 p-5 grid grid-rows-[auto_1fr_auto] min-h-0">
                  <div className="flex items-center gap-2 pb-3 border-b border-white/10">
                    <div className="w-8 h-8 rounded-full bg-green-500/30 border border-green-300/40 relative">
                  ...
                  <div className="grid grid-cols-3 gap-2 pt-3">
                    <Metric3D label="Consultas marcadas" value="+18%*" />
                    <Metric3D label="Primeira resposta" value="&lt; 5s" />
                    <Metric3D label="Satisfação" value="9.2/10" />
                  </div>
                </div>
              </div>
            </div>
        ...
        {/* MARQUEE NICHES com efeito 3D */}
        <section
          aria-label="Nichos em destaque"
          className="mt-8 mb-4 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-md marquee-3d"
          ...
          <div className="marquee-mask">
            <div className="marquee-track">
              {niches
                ...
                .concat(niches)
                .map((n, i) => (
                  <span key={i} className="marquee-pill-3d">
                    {n}
                  </span>
                ))}
            </div>
        ...
        {/* DEMOS - 3 nichos com CTAs e efeitos 3D */}
        ...
        {/* FEATURES - foco em atendimento com elementos 3D */}
        <section id="product" className="mt-16 reveal">
          ...
          <p className="mt-2 text-white/80 max-w-2xl">
            Respostas imediatas, qualificação de leads, <strong>agendamento/confirmação</strong> e integrações com
          ...
          <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
            <Feature3D
              ...
              desc="Tira dúvidas, envia instruções e coleta dados sem filas."
            >
              <a
            ...
            <Feature3D icon="🔗" title="Integrações" desc="CRM/Calendário, leitura de PDF e transcrição de áudios.">
              <a
                className="mt-4 inline-block btn-outline"
        ...
        <section id="lp" className="mt-16 reveal">
          ...
          <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-6">
            <Feature3D icon="⚡" title="Performance" desc="Pages leves, carregamento rápido e tracking." />
            <Feature3D icon="🎯" title="Conversão" desc="CTA direto para WhatsApp/DM e formulários otimizados." />
            <Feature3D icon="📈" title="Mensuração" desc="Relatórios simples e integração com pixel/GA." />
          </div>
          <div className="mt-6">
            <a
              className="btn-primary btn-shine"
        ...
        {/* PRICING com efeitos 3D modernos */}
        <section id="pricing" className="mt-16 reveal" data-selected-channel={channel}>
          ...
          {/* Linha única com drag-scroll e efeitos 3D */}
          <div
            ref={pricingRef}
        ...
        <section
          id="contact"
          className="mt-16 reveal rounded-2xl p-8 bg-white/5 border border-white/10 backdrop-blur-md contact-3d"
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              <div>
                ...
                <input id="name" name="name" required className="input-3d" placeholder="Seu nome" />
              </div>
              <div>
              ...
              <div>
                ...
                <textarea id="message" name="message" className="input-3d min-h-28" placeholder="Conte o que precisa" />
              </div>
              <div>
...
function Logo3D() {
  return (
    <div className="flex items-center gap-2 select-none">
      <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-blue-500/20 to-purple-500/20 border border-white/20 grid place-items-center shadow-inner logo-3d">
...
function InlineStyles() {
  return (
    <style>{`
      ...
      .nav-link::after { content:""; position:absolute; left:0; bottom:-2px; width:0; height:2px; background:linear-gradient(90deg, #818cf8, #a855f7); transition: width .25s; }
      ...
      .tile-3d { 
        ...
        border-radius:.9rem; 
        padding:1rem; 
        box-shadow: 0 18px 35px rgba(0,0,0,.35), inset 0 1px 0 rgba(255,255,255,.1); 
        transform: perspective(1000px) rotateX(0deg);
        transition: transform .3s ease, box-shadow .3s ease;
      }
      .tile-3d:hover {
        transform: perspective(1000px) rotateX(5deg) translateY(-2px);
        box-shadow: 0 25px 50px rgba(0,0,0,.5), inset 0 1px 0 rgba(255,255,255,.15);
      }
      ...
      .chat-container-3d:hover {
        ...
        box-shadow: 0 30px 60px rgba(0,0,0,.6), inset 0 1px 0 rgba(255,255,255,.15);
      }
      ...
      .segmented-3d { 
        ...
        box-shadow: 0 8px 25px rgba(0,0,0,.3), inset 0 1px 0 rgba(255,255,255,.1);
      }
      .segmented-3d button { 
        font-size:.8rem; 
        padding:.45rem .7rem; 
      ...
      .segmented-3d button:hover { 
        opacity:1; 
        transform: perspective(500px) rotateX(3deg);
      }
      .segmented-3d button.on { 
        background:linear-gradient(135deg, #16a34a, #15803d); 
        opacity:1; 
        box-shadow: 0 6px 18px rgba(22,163,74,.35), inset 0 1px 0 rgba(255,255,255,.2);
        transform: perspective(500px) rotateX(0deg);
      }
      ...
      .input-3d { 
        ...
        border-radius:.8rem; 
        padding:.6rem .9rem; 
        transition:border .2s, box-shadow .2s, background .2s, transform .2s;
        box-shadow: 0 4px 15px rgba(0,0,0,.2), inset 0 1px 0 rgba(255,255,255,.05);
      }
      .input-3d:focus { 
        outline:none; 
        border-color:#818cf8; 
        box-shadow:0 0 0 4px rgba(129,140,248,.2), 0 8px 25px rgba(0,0,0,.3), inset 0 1px 0 rgba(255,255,255,.1); 
      ...
      .contact-3d {
        transform: perspective(1000px) rotateX(0deg);
        transition: transform .3s ease, box-shadow .3s ease;
        box-shadow: 0 20px 40px rgba(0,0,0,.4), inset 0 1px 0 rgba(255,255,255,.08);
      }
      .contact-3d:hover {
        transform: perspective(1000px) rotateX(2deg);
        box-shadow: 0 25px 50px rgba(0,0,0,.5), inset 0 1px 0 rgba(255,255,255,.12);
      }
      ...
      .btn-primary{ 
        ...
        color:white; 
        font-weight:700; 
        box-shadow: 0 12px 26px rgba(99,102,241,.35), inset 0 1px 0 rgba(255,255,255,.2); 
      ...
      .btn-primary:hover{ 
        ...
        box-shadow: 0 16px 40px rgba(99,102,241,.45), inset 0 1px 0 rgba(255,255,255,.3); 
      }
      ...
      .btn-outline:hover{ 
        ...
        box-shadow: 0 12px 26px rgba(0,0,0,.35), inset 0 1px 0 rgba(255,255,255,.1); 
      }
      ...
      .btn-success{ 
        ...
        color:white; 
        font-weight:700; 
        box-shadow: 0 12px 26px rgba(22,163,74,.35), inset 0 1px 0 rgba(255,255,255,.2); 
        transition: transform .2s, box-shadow .2s;
        transform: perspective(500px) rotateX(0deg);
      }
      .btn-success:hover{ 
        transform: perspective(500px) rotateX(5deg) translateY(-2px); 
        box-shadow: 0 16px 40px rgba(22,163,74,.45), inset 0 1px 0 rgba(255,255,255,.3); 
      }
      ...
      .bubble-user{ background: linear-gradient(135deg, rgba(255,255,255,.18), rgba(255,255,255,.12)); }
      .bubble-agent{ background: linear-gradient(135deg, rgba(16,185,129,.3), rgba(16,185,129,.2)); border-color: rgba(110,231,183,.45); }
...
/* ----------------- Enhanced 3D UI Components ----------------- */
function Metric3D({ label, value }: { label: string; value: string }) {
  return (
    <div className="rounded-lg bg-gradient-to-br from-white/12 to-white/8 border border-white/15 px-3 py-2 transform perspective-500 hover:rotateX-5 hover:-translate-y-1 transition-all duration-300 shadow-lg hover:shadow-xl">
...
function MsgUser({ children }: { children: React.ReactNode }) {
  return (
    <div className="flex gap-2 items-start">
      <div className="w-7 h-7 rounded-full bg-gradient-to-br from-white/25 to-white/15 border border-white/30 shadow-lg" />
      <div className="bubble bubble-user shadow-lg">{children}</div>
    </div>
  )
}
...
function MsgAgent({ children }: { children: React.ReactNode }) {
  return (
    <div className="flex gap-2 items-start justify-end">
      <div className="bubble bubble-agent shadow-lg">{children}</div>
      <div className="w-7 h-7 rounded-full bg-gradient-to-br from-emerald-400/50 to-emerald-400/30 border border-emerald-200/40 shadow-lg" />
    </div>
  )
}
...
function MsgUserAudio({ duration }: { duration: string }) {
  return (
    <div className="flex gap-2 items-start">
      <div className="w-7 h-7 rounded-full bg-gradient-to-br from-white/25 to-white/15 border border-white/30 shadow-lg" />
      <div className="bubble bubble-user shadow-lg">
...
function MsgAgentAudio({ duration, text }: { duration: string; text: string }) {
  return (
    <div className="flex gap-2 items-start justify-end">
      <div className="bubble bubble-agent shadow-lg">
        <div className="audio-pill">
          <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
            <path d="M8 5v14l11-7z" />
          </svg>
...
function Feature3D({
  ...
  return (
    <div className="group relative rounded-2xl border border-white/10 bg-gradient-to-br from-white/8 to-white/3 p-6 backdrop-blur-md shadow-[0_18px_35px_rgba(0,0,0,.35)] transition-all hover:-translate-y-2 hover:shadow-[0_28px_60px_rgba(0,0,0,.45)] transform perspective-1000 hover:rotateX-3 hover:rotateY-2">
      <div className="text-3xl select-none transform transition-transform group-hover:scale-110">{icon}</div>
...
function AgentCard3D({
  ...
  return (
    <div
      ...
      className={`group relative rounded-2xl border ${featured ? "border-emerald-400/40" : "border-white/10"} bg-gradient-to-br from-white/8 to-white/3 p-5 backdrop-blur-md shadow-[0_18px_35px_rgba(0,0,0,.35)] transition-all hover:-translate-y-2 hover:shadow-[0_28px_60px_rgba(0,0,0,.45)] transform perspective-1000 hover:rotateX-3`}
    >
      ...
      {featured && (
        <div className="absolute -top-3 right-3 text-[10px] px-2 py-1 rounded-full bg-gradient-to-r from-emerald-500/40 to-emerald-400/30 border border-emerald-300/40 backdrop-blur-md shadow-lg">
          POPULAR
        </div>
      )}
    </div>
...
function PriceCard3D({
  ...
  return (
    <div
      ...
      className={`group relative rounded-2xl border ${featured ? "border-emerald-400/40 bg-gradient-to-br from-emerald-500/10 to-white/5" : "border-white/10 bg-gradient-to-br from-white/8 to-white/3"} p-6 backdrop-blur-md shadow-[0_18px_35px_rgba(0,0,0,.35)] transition-all hover:-translate-y-3 hover:shadow-[0_28px_60px_rgba(0,0,0,.45)] transform perspective-1000 hover:rotateX-5 hover:rotateY-2`}
    >
...
function Testimonial3D({ name, role, text }: { name: string; role: string; text: string }) {
  return (
    <div
      data-testid="testimonial-card"
      className="relative rounded-2xl border border-white/10 bg-gradient-to-br from-white/8 to-white/3 p-6 backdrop-blur-md shadow-[0_18px_35px_rgba(0,0,0,.35)] transition-all hover:-translate-y-2 hover:shadow-[0_28px_60px_rgba(0,0,0,.45)] transform perspective-1000 hover:rotateX-3 hover:rotateY-1"
    >
...
function DemoCard3D({
  ...
  return (
    <div
      ...
      className="group relative rounded-2xl border border-white/10 bg-gradient-to-br from-white/8 to-white/3 p-5 backdrop-blur-md shadow-[0_18px_35px_rgba(0,0,0,.35)] transition-all hover:-translate-y-2 hover:shadow-[0_28px_60px_rgba(0,0,0,.45)] transform perspective-1000 hover:rotateX-3"
    >
      ...
      <div className="space-y-2">
        {lines.map((l, i) => (
          <div key={i} className={`flex gap-2 items-start ${l.from === "agent" ? "justify-end" : ""}`}>
            {l.from === "user" && (
              <div className="w-6 h-6 rounded-full bg-gradient-to-br from-white/25 to-white/15 border border-white/30 shadow-sm" />
            )}
            <div
              className={`max-w-[80%] rounded-xl border px-3 py-2 text-sm shadow-sm ${l.from === "agent" ? "bg-gradient-to-br from-emerald-500/30 to-emerald-500/20 border-emerald-300/30" : "bg-gradient-to-br from-white/18 to-white/12 border-white/20"}`}
            >
              {l.text}
            </div>
            {l.from === "agent" && (
              <div className="w-6 h-6 rounded-full bg-gradient-to-br from-emerald-400/50 to-emerald-400/30 border border-emerald-200/40 shadow-sm" />
            )}
          </div>
        ))}
      </div>
...
function FAQItem({ q, a }: { q: string; a: string }) {
  ...
  return (
    <div className="border border-white/10 rounded-xl p-4 bg-gradient-to-br from-white/8 to-white/3 backdrop-blur-md shadow-lg transform transition-all hover:-translate-y-1 hover:shadow-xl">
      <button className="flex justify-between w-full text-left font-semibold" onClick={() => setOpen(!open)}>
        {q}
        <span className="transform transition-transform" style={{ transform: open ? "rotate(45deg)" : "rotate(0deg)" }}>
          {open ? "−" : "+"}
        </span>
      </button>
